...
MongoDB Connected to: mongodb://localhost:27017/drivebox Server running on port 5000
...
Left terminal: cd backend && npm run dev
Right terminal: cd frontend && npm start
