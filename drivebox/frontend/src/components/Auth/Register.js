  ...
  return (
    <Box sx={{
      ...
      <Paper elevation={0} sx={{
        p: { xs: 3, sm: 5 }, borderRadius: 4, width: '100%', maxWidth: 420,
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 4 }}>
          ...
          <Typography color="rgba(255,255,255,0.5)" mt={0.5}>Create your account</Typography>
        </Box>
        ...
        <Box component="form" onSubmit={handleSubmit}>
          <TextField fullWidth label="Full Name" name="name" value={form.name}
            onChange={handleChange} required sx={{ mb: 2, ...darkInputStyle }} />
        ...
        <Typography color="rgba(255,255,255,0.5)" textAlign="center" mt={3}>
          ...
          <Link component={RouterLink} to="/login" sx={{ color: '#667eea', fontWeight: 600 }}>
            Sign in
          </Link>
        </Typography>
      </Paper>
